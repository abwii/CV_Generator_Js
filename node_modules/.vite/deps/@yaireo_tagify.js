...
function M(t2) {
  return function(t3) {
    ...
    if ("Arguments" === i2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i2)) return S(t3, e2);
  }(t2) || function() {
    throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
  }();
}
...
var C = (_ = function(t2) {
      ...
      switch (t2.key) {
        ...
        case "Enter":
          t2.preventDefault(), i2.hooks.suggestionClick(t2, { tagify: e2, tagData: a2, suggestionElm: s2 }).then(function() {
            if (s2) return e2.dropdown.selectOption(s2), s2 = e2.dropdown.getNextOrPrevOption(s2, !c2), void e2.dropdown.highlightOption(s2);
          ...
          break;
        case "Backspace":
          if (o2 || e2.state.editing.scope) return;
  ...
  if (this.trigger("dropdown:select", { data: c2, elm: t2, event: e2 }), c2 || l2) {
    ...
    } else this[d2 ? "addMixTags" : "addTags"]([c2 || this.input.raw.call(this)], a2);
  ...
  if (!(t2 = "select" == u2.mode && this.value.length && this.value[0][u2.tagTextProp] == t2 ? "" : t2) || !w2.length) return p2 = b2 ? m2 : m2.filter(function(t3) {
    return !d2.isTagDuplicate(c(t3) ? t3.value : t3);
  }), this.state.dropdown.suggestions = p2, p2.slice(0, v2);
  for (r2 = g2.caseSensitive ? "" + t2 : ("" + t2).toLowerCase(); y2 < m2.length; y2++) i2 = this, l2();
...
function F(t2, e2) {
  return function(t3) {
    ...
    "Object" === i2 && t3.constructor && (i2 = t3.constructor.name);
    if ("Map" === i2 || "Set" === i2) return Array.from(i2);
    if ("Arguments" === i2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i2)) return P(t3, e3);
  }(t2, e2) || function() {
...
function K(t2) {
  return function(t3) {
    if (Array.isArray(t3)) return R(t3);
  }(t2) || function(t3) {
    if ("undefined" != typeof Symbol && null != t3[Symbol.iterator] || null != t3["@@iterator"]) return Array.from(t3);
  }(t2) || function(t3, e2) {
    if (!t3) return;
    if ("string" == typeof t3) return R(t3, e2);
    var i2 = Object.prototype.toString.call(t3).slice(8, -1);
    "Object" === i2 && t3.constructor && (i2 = t3.constructor.name);
    if ("Map" === i2 || "Set" === i2) return Array.from(i2);
    if ("Arguments" === i2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i2)) return R(t3, e2);
  }(t2) || function() {
    throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
  }();
}
var U = { customBinding: function() {
  ...
  if (!(h2 || p2 || o2)) if (r2 || s2 ? (this.state.hasFocus = +/* @__PURE__ */ new Date(), this.toggleFocusClass(this.state.hasFocus)) : this.state.hasFocus = false, "mix" != n2.mode) {
    if (r2) {
  ...
  if (this.state.hasFocus || s2 && !a2) {
    ...
    switch (t2.key) {
      case "Backspace":
        ...
        break;
      case "Enter":
        if (o2) return void this.removeTags(t2.target.parentNode);
      ...
      if ("mix" == i2.mode) {
        switch (t2.key) {
          ...
          case "Backspace":
            ...
            if (p() && B(d2, Element)) return g2 = l(d2), d2.hasAttribute("readonly") || d2.remove(), e2.DOM.input.focus(), void setTimeout(function() {
              y(g2), e2.DOM.input.click();
            });
            if ("BR" == a2.anchorNode.nodeName) return;
            if ((o2 || d2) && 1 == a2.anchorNode.nodeType ? u2 = 0 == a2.anchorOffset ? o2 ? h2[0] : null : h2[Math.min(h2.length, a2.anchorOffset) - 1] : o2 ? u2 = a2.anchorNode.nextElementSibling : B(d2, Element) && (u2 = d2), 3 == a2.anchorNode.nodeType && !a2.anchorNode.nodeValue && a2.anchorNode.previousElementSibling && t2.preventDefault(), (d2 || o2) && !i2.backspace) return void t2.preventDefault();
            if ("Range" != a2.type && !a2.anchorOffset && a2.anchorNode == e2.DOM.input && "Delete" != t2.key) return void t2.preventDefault();
            if ("Range" != a2.type && u2 && u2.hasAttribute("readonly")) return void y(l(u2));
...
function G(t2) {
  return function(t3) {
    ...
    if (!t3) return;
    if ("string" == typeof t3) return q(t3, e2);
    var i2 = Object.prototype.toString.call(t3).slice(8, -1);
    "Object" === i2 && t3.constructor && (i2 = t3.constructor.name);
    if ("Map" === i2 || "Set" === i2) return Array.from(i2);
    if ("Arguments" === i2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i2)) return q(t3, e2);
  }(t2) || function() {
    throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
  }();
}
function $(t2, e2) {
  ...
  u(this, function(t3) {
    ...
    return { removeAllCustomListeners: function() {
      ...
      if (a2 = a2 || { cloneData: true }, i4) if (t3.settings.isJQueryPlugin) "remove" == i4 && (i4 = "removeTag"), jQuery(t3.DOM.originalInput).triggerHandler(i4, [s4]);
        ...
        try {
          ...
          if ((r2 = a2.cloneData ? u({}, r2) : r2).tagify = this, s4.event && (r2.event = this.cloneEvent(s4.event)), V(s4, Object)) for (var l2 in s4) V(s4[l2], HTMLElement) && (r2[l2] = s4[l2]);
    ...
    var e3, i3 = "/" + t3;
    if (1 == localStorage.getItem(k + s2 + "/v", 1)) try {
...
$.prototype = { _dropdown: C, placeCaretAfterNode: y, getSetTagData: w, helpers: { sameStr: s, removeCollectionProp: a, omit: o, isObject: c, parseHTML: r, escapeHTML: d, extend: u, concatWithoutDups: g, getUID: f, isNodeTag: m }, customEventsList: ["change", "add", "remove", "invalid", "input", "paste", "click", "keydown", "focus", "blur", "edit:input", "edit:beforeUpdate", "edit:updated", "edit:start", "edit:keydown", "dropdown:show", "dropdown:hide", "dropdown:select", "dropdown:updated", "dropdown:noMatch", "dropdown:scroll"], dataProps: ["__isValid", "__removed", "__originalData", "__originalHTML", "__tagId"], trim: function(t2) {
  ...
  if (e2) {
    ...
    if (X(i2.focusNode, Element) && !this.DOM.input.contains(i2.focusNode)) return true;
    try {
